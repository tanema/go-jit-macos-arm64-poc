...
asm: clean ## build the asm files that are embedded into the JIT
	...
	@ld -o ./build/hello.bin ./build/hello.o -e _start -L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib -lSystem
	@ld -o ./build/write.bin ./build/write.o -e _start -L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib -lSystem
...
bingo: ## translate a flat binary file to go code for use in the code
	@go run ./bin_to_go.go
